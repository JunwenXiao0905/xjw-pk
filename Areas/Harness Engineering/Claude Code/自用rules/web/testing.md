> This file extends [common/testing.md](Areas/Harness%20Engineering/Claude%20Code/自用rules/common/testing.md) with web-specific testing content.
...
- Keep CWV targets from [performance.md](Areas/Harness%20Engineering/Claude%20Code/自用rules/web/performance.md)
