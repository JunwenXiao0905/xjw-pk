...
> 此文件扩展了 [common/git-workflow.md](Areas/Harness%20Engineering/Claude%20Code/个人笔记/学习/everything-claude-code/rules/common/git-workflow.md)，涵盖 git 操作之前的完整功能开发过程。
...
4. **提交与推送**
   ...
   - 提交消息格式和 PR 流程见 [git-workflow.md](Areas/Harness%20Engineering/Claude%20Code/个人笔记/学习/everything-claude-code/rules/common/git-workflow.md)
